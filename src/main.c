...
int main(int argc, char **argv)
{
    ...
    // This will wake all threads sleeping on the ring buffer's condition
    // variable and tell them to shut down.
